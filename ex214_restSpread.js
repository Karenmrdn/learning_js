...
/* TASK 1 */
/*
Create a function "meanScore" that will accept any quantity of the arguments, 
gather them into single array and return mean value of all arguments rounded to 2 decimal places.
...
console.log(calcMeanScore(...scores1)); // 1.93

console.log(calcMeanScore(...scores1, ...scores2)); // 2.8

console.log(calcMeanScore(...scores1, ...scores2, ...scores3)); // 2.59

console.log(calcMeanScore(...scores4)); // Supplied arguments must contain only numbers!
